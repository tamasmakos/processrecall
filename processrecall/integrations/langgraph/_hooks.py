...
:class:`processrecall.Memory`. They are
...
async def recall(
    ...
    *,
    ...
    :class:`~processrecall.models.hit.Hit` objects (``speaker``, ``ts``, ``score``,
    ...
    :func:`~processrecall.models.hit.render_memories` — deduped, dated, attributed,
