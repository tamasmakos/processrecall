"""Runtime facade for processrecall memory operations.
...
from processrecall.bounds import (
    check_limit,
    check_metadata_size,
    check_scope_id,
    check_text_length,
...
from processrecall.ingestion.parsers.text import PlainTextParser, strip_content_heading
from processrecall.models.fact import FactState
from processrecall.models.hit import Hit
from processrecall.models.message import Message
from processrecall.models.report import Counters, IngestReport, RecallBudget, RecallResult
from processrecall.models.segment import Segment, SegmentKind
from processrecall.models.source import Source, session_uri
from processrecall.packs import DomainPack, load_packs
from processrecall.settings import Decoder, GraphKnowsSettings, MemoryMode, get_settings
from processrecall.storage.arcadedb._sql import not_forgotten
from processrecall.storage.arcadedb.writers import WRITTEN_TYPES
...
def _build_extractor(settings: GraphKnowsSettings) -> Any:
    ...
    from processrecall.ingestion.extraction.protocol import LLMExtractor, LocalExtractor
...
class Memory:
    """The processrecall memory facade — the primary developer-facing API.
    ...
    async def doctor(self) -> dict[str, Any]:
        ...
        from processrecall._version import get_version
    ...
    async def ingest_memory(
        ...
        *,
        ...
        from processrecall.models.message import normalize_messages
    ...
    async def recall_memory(
        ...
        *,
        ...
        Hits are :class:`~processrecall.models.hit.Hit` objects, not dicts — one
        ...
        :func:`~processrecall.models.hit.render_memories`; transports that cannot
        carry the type call :meth:`~processrecall.models.hit.Hit.to_dict`.
