...
Usage::
    ...
    python -m processrecall.symbolic.ontology.rdf --source ./my-ontology --ns my_rdf --reset
    python -m processrecall.symbolic.ontology.rdf --source ./my-ontology --ns my_rdf \\
        --digest-out my.json
...
def main() -> int:
    ...
    p.add_argument("--ns", required=True, help="processrecall namespace (database mem_<ns>)")
