"""Export the extracted taxonomy as a standard processrecall ontology digest.

The digest is the one shape the whole package reads an ontology through
(:func:`~processrecall.symbolic.ontology.loader.load_ontology_terms`), and it is plain JSON:
...
:func:`~processrecall.symbolic.ontology.rdf.store.taxon_rows` picks it. A taxon merges every
...
:func:`~processrecall.symbolic.ontology.skos.ancestors` stops its walk at them.
...
def to_digest(
    ...
    Args:
        taxonomy: The ``DiGraph`` from :func:`~processrecall.symbolic.ontology.rdf.taxonomy.extract`
    ...
    Returns:
        ...
        :func:`processrecall.symbolic.ontology.digest.build` returns, loadable by
        :func:`~processrecall.symbolic.ontology.loader.load_ontology_terms`.
    """
