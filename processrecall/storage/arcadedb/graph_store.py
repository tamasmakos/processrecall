...
:mod:`processrecall.storage.arcadedb.writers`, one writer per vertex family; what
...
- openCypher has no ``IN $list`` — every interpolated string goes through
  :mod:`processrecall.storage.arcadedb._sql`.
"""
...
from processrecall.exceptions import SchemaVersionMismatchError, StoreError
...
from processrecall.storage.arcadedb._sql import (
    is_missing_type,
    not_forgotten,
    quote,
    quoted_list,
...
class GraphStore(ArcadeStoreBase):
    ...
    Args:
        ...
        db: Database name, from :func:`processrecall.storage.namespace.db_name`.
    """
